...
<head>
    ...
    <title>CANALES DE TELEVISIÓN MUNDIAL</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="./">Canales de televisión mundial</a>
            <div>
                <a href="https://www.configuroweb.com/46-aplicaciones-gratuitas-en-php-python-y-javascript/#Aplicaciones-gratuitas-en-PHP,-Python-y-Javascript" class="text-light fw-bolder h6 text-decoration-none" target="_blank"></a>
            </div>
        </div>
    </nav>
    <div class="container px-5 my-3">
        <h2 class="text-center">CRUD Canales de TELEVISIÓN</h2>
        <div class="row">
                                ...
                                <table class="table table-stripped table-bordered">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">StreamFormat</th>
